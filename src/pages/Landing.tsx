  ...
  return (
    <SiteShell headerCode="NYC / 40°45′N">
      <section className="hero-section" id="top">
        <div className="hero-copy">
          ...
          <p>
            ...
            lock a boundary, write one prompt, and compare three GPT Image routes—blind, screenshot, and geometry-locked.
          </p>
      ...
      <section className="sequence" id="method">
        ...
        <article><span>03 / WEBMCP</span><h2>OSM vectors locked</h2><p>The agent reads page state and renders source-backed geometry. It cannot move the city.</p></article>
      </section>
    </SiteShell>
  )
}
